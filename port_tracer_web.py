...
from utils import (
    is_valid_mac, get_mac_format_error_message,
    format_switches_for_frontend, get_site_floor_switches,
...
def detect_switch_model_from_config(switch_name, switch_config):
    ...
    # Extract model from explicit model field - check for specific N3248 first
    if 'N3248' in model:
    ...
    # Default assumption - use N3000 as the original default
    return 'N3000'
...
# apply_role_based_filtering function is imported from utils module

# DellSwitchSSH class is imported from switch_manager module
